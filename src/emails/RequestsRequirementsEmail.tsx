...
const RequestsRequirementsEmail = ({
  name,
  appUrl,
  event_title,
  event_date,
      ...
      <Body>
        <Container>
          <Section>
            ...
            <Text>
              Please Upload the following documents to your account to proceed
              with your request or just email us and attach this required
              documents to process your request
            </Text>
          </Section>

          <Section>
            <Heading as="h3">Required Documents:</Heading>
            <Row>
              <Column>
                <Text>Valid ID</Text>
              </Column>
...
export default RequestsRequirementsEmail;
