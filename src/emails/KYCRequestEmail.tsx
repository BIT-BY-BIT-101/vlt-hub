...
const KYCRequestEmail = ({ name, appUrl, event_title, event_date }: Props) => {
  return (
    <Html>
      <Head />
      ...
      <Body>
        <Container>
          <Section>
            ...
            <Text>
              We have recieved your request to verify your account. Please wait
              for approval
            </Text>
          </Section>
...
export default KYCRequestEmail;
